...
try {
    ...
    $query = "SELECT * FROM title WHERE subcategory_id = 7";
...
<body>
    <nav class="nav-container" id="navbar" style="color: white; font-weight: bold;">
        <div class="nav-item" style="flex-grow: 2; font-size: 20px;">暴行の情報ガイド</div>
        <div class="nav-item" style="flex-grow: 2; font-size: 20px;">日本で暴行を受けたときの対応に関する情報をカードスタイルで提供</div>
    ...
    <div>
        <main id="card-container">
            <?php foreach ($titles as $title) : ?>
                ...
                // 画像ファイルのパスを生成
                $imageFilePath = './detail_img/07/' . $title['title_id'] . '.jpg';
